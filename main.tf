...
resource "aws_s3_bucket" "my_bucket" {
  bucket = "qr-code-bucket-848392"
#   acl    = "public-read"
}

# Lambda function
resource "aws_lambda_function" "my_lambda" {
  function_name    = "qr-code-bucket-848392"
  ...
  role = "arn:aws:iam::381492132216:role/service-role/QR-code-function-role-d7xv7age" # Change this to your existing IAM role ARN
